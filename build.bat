...
cmd.exe /c "call "!VCVARS!" amd64 && cl.exe /nologo /std:c++latest /utf-8 /EHsc /MT /O2 /guard:cf /Isrc/shared /Isrc/ime-dll /Isrc/core /Fo"!OBJ_X64!\\" /Fe!OUT_DIR!\neokey_config.exe src\config-app\main.cpp src\shared\logger.cpp src\shared\tray_ipc.cpp !OUT_DIR!\resources.res /link /subsystem:windows comctl32.lib advapi32.lib user32.lib comdlg32.lib gdi32.lib gdiplus.lib shell32.lib dwmapi.lib uxtheme.lib winhttp.lib /guard:cf /DYNAMICBASE /NXCOMPAT"
if errorlevel 1 exit /b 1
...
cmd.exe /c "call "!VCVARS!" amd64_arm64 && cl.exe /nologo /std:c++latest /utf-8 /EHsc /MT /O2 /guard:cf /Isrc/shared /Isrc/ime-dll /Isrc/core /Fo"!OBJ_CONFIG_ARM64!\\" /Fe!OUT_DIR!\neokey_config_arm64.exe src\config-app\main.cpp src\shared\logger.cpp src\shared\tray_ipc.cpp !OUT_DIR!\resources_arm64.res /link /subsystem:windows comctl32.lib advapi32.lib user32.lib comdlg32.lib gdi32.lib gdiplus.lib shell32.lib dwmapi.lib uxtheme.lib winhttp.lib /guard:cf /DYNAMICBASE /NXCOMPAT"
if errorlevel 1 exit /b 1
